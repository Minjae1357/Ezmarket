...
public class SimpleSecurityConfig {
	...
	SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
	    ...
	    http.authorizeHttpRequests((authz) -> authz
	            .requestMatchers("/user/sendVerificationEmail","/oauth2/**","/login/oauth2/code/google","/user/login","/user/check","/","/register","/auth/{code}","/sec/", "/user/loginForm", "/sec/denied", "/logout", "/sec/menu").permitAll()
